...
class ContouringSecondOrderUnicycleModel(DynamicsModel):
    ...
    def __init__(self):
        ...
        # w = 0.8
        self.lower_bound = [-2.0, -1.2, -2000.0, -2000.0, -np.pi * 4, -0.01, -1.0]
        #                   a_lb   w_lb   x_lb     y_lb     psi_lb     v_lb   spline_lb
        self.upper_bound = [1.0, 1.2, 2000.0, 2000.0, np.pi * 4, 1.0, 10000.0]
